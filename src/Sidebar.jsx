...
function Sidebar({ activeView, onNavigate, onLogout, userName, userPhone, isAdmin }) {
  ...
  return (
    <>
      ...
      <div className="sidebar-section">
        ...
        <button 
          className={`sidebar-button ${activeView === 'viewDC' ? 'active' : ''}`}
          onClick={() => handleNavigation('viewDC')}
        >
          📋 View DC
        </button>
      </div>
      ...
      {isAdmin && (
        <div className="sidebar-section">
          ...
          <button 
            className={`sidebar-button ${activeView === 'userApprovals' ? 'active' : ''}`}
            onClick={() => handleNavigation('userApprovals')}
          >
            👥 User Approvals
          </button>
        </div>
